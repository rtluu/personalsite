...
const LightboxImagesOpenRecord = (props) => {
    ...
    return (
        <div className={`lightbox-image-wrapper ${imageNumber === 1 | imageNumber === 8 | imageNumber === 12 ? "video-wrapper" : ""}`}>
            {imageNumber === 1 && !videoExpanded ? <div className="media-box"><div className="loading-spinner" /><HeroOpenRecord /><Player ytid="558t8VG-zzw" /></div> : null}
            ...
            {imageNumber === 8 && !videoExpanded ? <div className="media-box"><div className="loading-spinner" /><OpenRecordWorkingDesign /><Player ytid="ghqab6X17pE" /></div> : null}
            {imageNumber === 9 && (<OpenRecordLiveMobile />)}
            {imageNumber === 10 && (<OpenRecordHomepage />)}
            {imageNumber === 11 && (<OpenRecordFeedback />)}
            {imageNumber === 12 & !videoExpanded ? <div className="media-box"><div className="loading-spinner" /><OpenRecordAddSong /><Player ytid="1PlqPOvsyA0" /></div> : null}
